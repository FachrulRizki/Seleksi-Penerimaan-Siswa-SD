            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}"
                        href="{{ route('admin.dashboard') }}" id="get-url" aria-expanded="false">
        ...
        <div class="fixed-profile p-3 mx-4 mb-2 bg-primary-subtle rounded mt-3">
            <div class="hstack gap-3">
                ...
                <div class="john-title text-nowrap text-truncate">
                    <h6 class="mb-0 fs-4 fw-semibold text-truncate">{{ Auth::guard('admin')->user()->nama }}</h6>
                    <span class="fs-2 text-capitalize">Admin</span>
                </div>
