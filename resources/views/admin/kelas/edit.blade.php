                    ...
                    <div class="col-9">
                        ...
                        <nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '/'">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active text-primary" aria-current="page">Edit Kelas</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
            ...
            <div class="card-body">
                <form action="{{ route('admin.kelas.update', $kelas->id) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" placeholder="Contoh: III.A" value="{{ old('nama', $kelas->nama) }}">
                        @error('nama')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="tahun_ajaran" class="form-control @error('tahun_ajaran') is-invalid @enderror" placeholder="Contoh: 2025/2026" value="{{ old('tahun_ajaran', $kelas->tahun_ajaran) }}">
                            @error('tahun_ajaran')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="wali_guru_id" class="form-select @error('wali_guru_id') is-invalid @enderror">
                                ...
                                @foreach($gurus as $g)
                                    <option value="{{ $g->id }}" {{ old('wali_guru_id', $kelas->wali_guru_id) == $g->id ? 'selected' : '' }}>
                                        {{ $g->nama }}
                                    </option>
                                @endforeach
                            </select>
