    ...
    <div class="card bg-primary-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Edit Soal</h4>
                    <nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '/'">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-primary" aria-current="page">Edit Soal</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
                    ...
                    <div class="card-body text-center">
                        <div>
                            ...
                            <div class="border rounded-3 mb-3 d-flex align-items-center justify-content-center bg-light" style="height: 250px; overflow: hidden;">
                                <img id="img-preview" src="{{ asset('storage/' . $soal->gambar_soal) }}" class="img-fluid" style="max-height: 100%; object-fit: contain;">
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            @php
                                $indexJawaban = $soal->opsiJawaban->search(fn($o) => $o->is_benar);
                            @endphp
                            <select name="jawaban" class="form-select border-success @error('jawaban') is-invalid @enderror">
                                ...
                                <option value="0" @selected(old('jawaban', $indexJawaban) == 0)>Opsi A</option>
                                <option value="1" @selected(old('jawaban', $indexJawaban) == 1)>Opsi B</option>
                                <option value="2" @selected(old('jawaban', $indexJawaban) == 2)>Opsi C</option>
                                <option value="3" @selected(old('jawaban', $indexJawaban) == 3)>Opsi D</option>
                            </select>
                            @error('jawaban')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
