            ...
            <div class="card-body">
                <form action="{{ route('admin.siswa.update', $siswa->id) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" placeholder="Budiono Siregar" value="{{ old('nama', $siswa->nama) }}">
                        @error('nama')
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="nis" class="form-control @error('nis') is-invalid @enderror" placeholder="1234" value="{{ old('nis', $siswa->nis) }}">
                            @error('nis')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="nisn" class="form-control @error('nisn') is-invalid @enderror" placeholder="123456789" value="{{ old('nisn', $siswa->nisn) }}">
                            @error('nisn')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
